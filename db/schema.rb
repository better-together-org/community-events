...
ActiveRecord::Schema.define(version: 20170927183223) do
  ...
  create_table "programme_item_translations", force: :cascade do |t|
    t.integer  "programme_item_id", limit: 4,     null: false
  ...
  add_index "programme_item_translations", ["locale"], name: "index_programme_item_translations_on_locale", using: :btree
  add_index "programme_item_translations", ["programme_item_id"], name: "index_programme_item_translations_on_programme_item_id", using: :btree
  ...
  create_table "published_programme_item_translations", force: :cascade do |t|
    t.integer  "published_programme_item_id", limit: 4,     null: false
    t.string   "locale",                      limit: 255,   null: false
    t.datetime "created_at",                                null: false
    t.datetime "updated_at",                                null: false
    t.string   "title",                       limit: 255
  ...
  add_index "published_programme_item_translations", ["locale"], name: "index_published_programme_item_translations_on_locale", using: :btree
  add_index "published_programme_item_translations", ["published_programme_item_id"], name: "index_47691ee9b0f066369d41ba61d21b9e27ee2e3590", using: :btree
  ...
  create_table "site_configs", force: :cascade do |t|
    ...
    t.integer  "back2back_margin",      limit: 4,   default: 0
  end
